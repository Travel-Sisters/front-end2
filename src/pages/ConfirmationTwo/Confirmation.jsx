            ...
            <section className="point" id="page-create-point">
                <div className="point-container container grid">
                    <div id="page-create-point">
                        ...
                        <form >
                            <h1 style={{ color: '#202020', fontSize: '1.7rem' }}>confirme seu destino</h1>
                            <p style={{ color: '#999999', fontSize: '1rem', fontWeight: '500' }}>revise os detalhes da sua jornada e junte-se ao seu grupo de viagem!</p>
